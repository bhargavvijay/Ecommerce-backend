...
let transporter = nodemailer.createTransport({
  ...
  auth: {
  user: 'shopnestoffical@gmail.com',
  pass: 'gmoy qzdr ohdi gxcy', // pass
  }
  });

  exports.sendMail = async function ({to, subject, text, html}){
    let info = await transporter.sendMail({
        from: '"ShopNest" <shopnestoffical@gmail.com>', // sender address
        to,
        subject,
        text,
        html
...
exports.invoiceTemplate = function(order){
         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
           <tr>
             <td align="center" valign="top" style="padding: 36px 24px;">
                 <img src="https://drive.google.com/file/d/1-IoMKqctfnvwYjf6FTaLTUMgrJsPMPMb/view?usp=sharing" alt="Logo" border="0" width="48" style="display: block; width: 48px; max-width: 48px; min-width: 48px;">
             </td>
           </tr>
         </table>
         <!--[if (gte mso 9)|(IE)]>
                 ...
                 <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 300px;">
                   <tr>
                     <td align="left" valign="top" style="padding-bottom: 36px; padding-left: 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                       ...
                       <p>${order['address']['full-name']}<br>${order['address'].street}<br>${order.address.city},${order.address.state},${order.address['postal-code']}</p>
 ...
 exports.EmailVerificationTemplate = function(link) {
  return (
    `<!DOCTYPE html>
    <html>
    <head>
